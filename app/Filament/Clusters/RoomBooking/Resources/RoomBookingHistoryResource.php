...
use App\Filament\Clusters\RoomBooking\Resources\RoomBookingHistoryResource\Pages;
use App\Filament\Clusters\RoomBooking\Resources\RoomBookingHistoryResource\RelationManagers;
...
class RoomBookingHistoryResource extends Resource
{
    ...
    protected static ?string $label = "Booking Histories    ";
...
//                            ->color('primary'),
    ...
    {
        return [
            'index' => Pages\ListRoomBookingHistories::route('/'),
            'create' => Pages\CreateRoomBookingHistory::route('/create'),
            'edit' => Pages\EditRoomBookingHistory::route('/{record}/edit'),
        ];
    }
}
