...
@section('content')
    <section class="grid grid-cols-4 gap-16">
        ...
        <div class="col-span-3 " x-data="{ openModalId: null }">
            <div>
                <h2 class="text-2xl mb-8">Booked Room</h2>
                <table class="min-w-full bg-white border  border-font/20 rounded-lg">
                    ...
                    @forelse ($rooms as $index => $room)
                        <tr class="border-t border-font/20 transition ease-in-out {{
                                $room->status === 'returned' ? 'bg-neutral-100 text-font/60' : ''
                            }}">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-4 py-2 rounded-lg text-xs font-normal {{
                                    match ($room->status) {
                                        'schedule' => ' bg-blue-50 text-blue-500',
                        ...
                        <div x-show="openModalId === {{ $room->id }}" class="fixed inset-0 z-50 bg-black/50 flex justify-center items-center" x-cloak>
                            <div class="w-[42%] min-h-[40vh] bg-white rounded-xl p-6">
                                ...
                                <div class="grid grid-cols-2 gap-y-3 text-sm text-font/70 pb-4  border-b  border-font/20 mb-4">
                                ...
                                <div class="grid grid-cols-2 gap-y-3 text-sm text-font/70">
