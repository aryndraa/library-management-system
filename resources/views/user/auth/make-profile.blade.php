...
@section('content')
    <section class="max-h-[110vh]">
        ...
        <div class="mx-32 p-12 px-16 rounded-xl transform -translate-y-64 bg-white">
            ...
            <form action="#" class="grid grid-cols-2 gap-8">
                <div class="col-span-2 grid grid-cols-2 items-end gap-10 ">
                ...
                <div class="grid grid-cols-2 col-span-2 gap-10 ">
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <button class="flex flex-col col-span-full w-full px-4 lg:px-6  py-3 border-none focus:ring-0 bg-primary-300 text-white font-medium rounded-lg focus:outline-none placeholder:text-font/30">
                            Submit
                        </button>
                    </div>
                </div>
