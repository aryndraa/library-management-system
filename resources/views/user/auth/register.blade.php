...
@section('content')
    <section class="grid grid-cols-1 lg:grid-cols-4 overflow-y-hidden">
        <div
            class="min-h-[25vh]  lg:min-h-[94vh] lg:m-5 lg:py-6 p-5 lg:px-8 bg-black-300 col-span-2 lg:rounded-xl bg-cover bg-center bg-blend-overlay bg-black/20"
        ...
        <div class="col-span-2  px-5  py-6 lg:ml-20 lg:mr-32  lg:min-h-[94vh]  flex items-center transform -translate-y-12 rounded-t-xl bg-white">
            <div class="w-full ">

                <div class="mb-6 lg:mb-8  lg:block">
                ...
                <form action="/member/register" method="post">
                    @csrf
                    <div class="flex flex-col gap-4 lg:gap-6 mb-12">
