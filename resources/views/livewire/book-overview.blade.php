<div>
    <div class="flex flex-col gap-8 lg:gap-8 lg:flex-row justify-between lg:items-end mb-8 lg:mb-16">
        <div>
        ...
        <div class="flex overflow-x-scroll lg:overflow-hidden gap-4 lg:gap-6 text-lg">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 2xl:gap-y-10 min-h-[280px] mt-6">
